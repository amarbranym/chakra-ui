...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    PaymentType: Attribute.Enumeration<
      ['Registration Fees', 'Providing Charges', 'Salary Commission']
    >;
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Category: Attribute.Enumeration<
      ['Technical', 'Non-Technical', 'Medical', 'Communication', 'Other']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    experience: Attribute.Component<'student.experience', true> &
      Attribute.SetMinMax<
        {
          max: 5;
        },
        number
      >;
    qualification: Attribute.Component<'student.qualification', true>;
    ...
    CandidateType: Attribute.Enumeration<
      ['White Collar', 'Labour', 'Blue Collar']
    > &
...
export interface ApiVacanyVacany extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Status: Attribute.Enumeration<['Open', 'Closed', 'Filled']>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::vacany.vacany': ApiVacanyVacany;
    }
  }
}
