...
export interface StudentInterview extends Schema.Component {
  collectionName: 'components_student_interviews';
  info: {
  ...
  attributes: {
    Company: Attribute.Relation<
      ...
      'api::company.company'
    >;
    DateOfInterview: Attribute.Date;
    Result: Attribute.Enumeration<['Pending', 'Selected', 'Rejected']>;
